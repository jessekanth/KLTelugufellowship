...
<div style="display:grid;grid-template-columns:1fr 1fr 1fr;width:100%;height:100%;font-family:'Segoe UI',Arial,sans-serif;background:#fff;color:#111;font-size:12.5px;box-sizing:border-box;line-height:1.45;">
  ...
  <div style="padding:8px 10px;border:2px solid #c8860a;display:flex;flex-direction:column;align-items:center;gap:3px;overflow:hidden;">
    ...
    <!-- Church photo -->
    <div style="width:100%;height:290px;overflow:hidden;background:#eee;display:flex;align-items:center;justify-content:center;position:relative;border-radius:4px;flex-shrink:0;">
